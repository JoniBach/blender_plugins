...
This module provides a production-ready library for generating neon shop name objects in Blender,
featuring clean code, adherence to DRY principles, and pure functions where possible.
